...
class _CartPageContentState extends State<CartPageContent> {
  ...
  createListCart() {
    return Container(
      ...
      height: 400,
      child: cartPageBloc.foodList.length == 0 ? Center(child: CircularProgressIndicator()) : ListView.builder(
          ...
          child: ListBody(
            children: <Widget>[
              ...
              TextField(
                ...
                autofocus: true,
                decoration: InputDecoration(labelText: 'Name', hintText: 'eg. Akshay')
              ),
              TextField(
                controller: addressTextController,
                autofocus: true,
                decoration: InputDecoration(labelText: 'Address', hintText: 'eg. st road west chembur')
              )
            ]
          )
        ),
